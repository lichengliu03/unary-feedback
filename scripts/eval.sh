...
ENV="${ENV:=metamathqa}"
ENV_TAG="${ENV_TAG:=MetamathQASpecificFeedback}"
MODEL="${MODEL:-/workspace/loaded_checkpoints/metamathqa_qwen25_3b_specific_5attempts_5turns/ufb_exp/metamathqa_qwen25_3b_specific_5attempts_5turns/global_step_200/actor/hf_merged}"
