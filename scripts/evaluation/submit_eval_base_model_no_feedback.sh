...
#SBATCH --job-name=eval_base_no_feedback
...
#SBATCH --mem=64G
#SBATCH -t 12:00:00
#SBATCH -o slurm-eval_base_no_feedback-%j.out
#SBATCH -e slurm-eval_base_no_feedback-%j.err
...
MODEL_NAME="${MODEL_NAME:-qwen25_3b_base_no_feedback}"
...
bash scripts/evaluation/eval_base_model_no_feedback.sh
