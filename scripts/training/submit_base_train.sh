...
CKPT_DIR="/projects/bfea/lliu22/ragen_checkpoints/${MODEL_NAME}_${TRAIN_MAX_TURN}turn_200steps"
mkdir -p "${CKPT_DIR}"
...
srun --ntasks=1 --cpus-per-task="${SLURM_CPUS_PER_TASK}" \
  python train.py \
    ...
    trainer.experiment_name="${MODEL_NAME}_${TRAIN_MAX_TURN}turn_200steps" \
