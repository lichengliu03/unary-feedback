...
export ENV_TAG="MetamathQAFirstTurnSuccess"
export MODEL_PATH="Qwen/Qwen2.5-3B-Instruct"
export FEEDBACK_MODE="specific"
export ATTEMPT_TIMES="5"
export TURN_PER_ATTEMPT="5"
export MAX_TURN="5"
export EXPERIMENT="metamathqa_qwen25_3b_success_first_5attempts_5turns"
