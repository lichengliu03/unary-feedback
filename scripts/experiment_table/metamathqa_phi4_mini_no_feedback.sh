...
export ENV_TAG="MetamathQANoFeedback"
export MODEL_PATH="microsoft/Phi-4-mini-instruct"
export FEEDBACK_MODE="no-feedback"
export ATTEMPT_TIMES="5"
export TURN_PER_ATTEMPT="5"
export MAX_TURN="5"
export EXPERIMENT="metamathqa_phi4_mini_no_feedback_5attempts_5turns"
