...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_rollout(self, default_local_dir: str):
        ...
        if rollout_name == 'hf':
            ...
            from ufb.workers.rollout.vllm_rollout.vllm_rollout_spmd import vLLMRollout
            from ufb.workers.sharding_manager.fsdp_vllm import FSDPVLLMShardingManager
    ...
    def init_model(self, default_local_dir: str=None):
        from ufb.workers.actor import DataParallelPPOActor
...
class CriticWorker(Worker):
    ...
    def init_model(self):
        ...
        from ufb.workers.critic import DataParallelPPOCritic
