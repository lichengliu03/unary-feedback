...
from ufb.env.spatial.config import SpatialGymConfig
from ufb.env.spatial.Base.tos_base.utils.room_utils import RoomGenerator
from ufb.env.spatial.Base.tos_base.actions.actions import ActionSequence, ACTION_REMINDER
from ufb.env.spatial.Base.tos_base.evaluation.task_types import EvalTaskType
from ufb.env.spatial.Base.tos_base.managers.exploration_manager import ExplorationManager
from ufb.env.spatial.prompter import SpatialPrompter
...
if __name__ == "__main__":
    ...
    from ufb.env.spatial.Base.tos_base.utils.room_utils import RoomPlotter
