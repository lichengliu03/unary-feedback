...
def process_aime24(item: Dict[str, Any]) -> Tuple[str, str]:
    """Process AIME24 dataset item.

    The AIME24 dataset has:
    - problem: the question text
    - solution: contains answer in \boxed{...} format
    """
    question = item.get("problem", item.get("question", ""))
    ...
    if boxed_match:
        ...
        # Fallback: try to get answer field directly
