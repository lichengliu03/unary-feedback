...
class MetaMathQAEnvNoFeedback(BaseLanguageBasedEnv):
    """
    MetaMathQA environment with NO feedback on incorrect answers.
    Instead of "Incorrect. Please think again.", returns empty string.
    """
    def __init__(self, config: MetaMathQAEnvConfig):
        super(MetaMathQAEnvNoFeedback, self).__init__()
    ...
    def step(self, action):
        ...
        if is_correct or self.step_num >= self.max_steps:
            ...
            # CHANGED: Empty observation instead of "Incorrect. Please think again."
            observation = ""
            done = False
            self.render_cache = observation
...
if __name__ == "__main__":
    ...
    env = MetaMathQAEnvNoFeedback(config)
    ...
    while True:
        ...
        # Print the results
        print("\nFeedback:", repr(obs))  # Use repr to show empty string clearly
        print("Reward:", reward)
        print("Done:", done)
        print("Info:", info)
